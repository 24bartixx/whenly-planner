...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Task&&(identical(other.title, title) || other.title == title)&&(identical(other.done, done) || other.done == done)&&(identical(other.priority, priority) || other.priority == priority)&&(identical(other.taskDdl, taskDdl) || other.taskDdl == taskDdl)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}


@override
int get hashCode => Object.hash(runtimeType,title,done,priority,taskDdl,createdAt);

@override
String toString() {
  return 'Task(title: $title, done: $done, priority: $priority, taskDdl: $taskDdl, createdAt: $createdAt)';
}
...
class _Task implements Task {
  const _Task({required this.title, required this.done, required this.priority, required this.taskDdl, required this.createdAt});
